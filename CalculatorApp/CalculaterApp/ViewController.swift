...
class ViewController: UIViewController {
    ...
    enum CalulateStatus {
       ...
       var firstNumber = ""
       var secondNumber = ""
       var calculateStatus : CalulateStatus = .none
    ...
    let cellId = "cellId"
       ...
       @IBOutlet weak var callculatorCollectionView: UICollectionView!
       @IBOutlet weak var calculaterHeightConstraint: NSLayoutConstraint!
       
       override func viewDidLoad() {
           super.viewDidLoad()
    
           
           callculatorCollectionView.delegate = self
           callculatorCollectionView.dataSource = self
           callculatorCollectionView.register(CalculatorViewCell.self, forCellWithReuseIdentifier:
            "cellId")
           calculaterHeightConstraint.constant = view.frame.width * 1.4
           callculatorCollectionView.backgroundColor = .clear
           callculatorCollectionView.contentInset = .init(top: 0, left: 14, bottom: 0, right: 14)
...
extension ViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = callculatorCollectionView.dequeueReusableCell(withReuseIdentifier: "cellId", for: indexPath) as! CalculatorViewCell
